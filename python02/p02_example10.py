...
# The following print statement is not part of the elif condition above. It will be executed regardless of the condition.
#print("Have a great day!")  # This statement must be indented to be part of the elif block, otherwise it will result in an error
